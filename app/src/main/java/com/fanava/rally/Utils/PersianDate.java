...
/**
 * Created by hamidelahi on 7/5/2017.
 */
...
private long Firstmilli;//the milli second in date
    Calendar calendar;
    ...
    public PersianDate(DateTime calendar) {
        setGregorianDate(calendar.getYear(),
    ...
    public long getFirstTimeInMilli() {
        return Firstmilli;
    }
    public long getLastTimeInMilli() {
        return lastMilli;
    }
    /**
     * getGregorianMonth:
    ...
    public void setGregorianDate(int year, int month, int day) {
      ...
      Firstmilli= calendar.getTimeInMillis();

        calendar.set(Calendar.HOUR_OF_DAY,23);
        calendar.set(Calendar.MINUTE,59);
        calendar.set(Calendar.SECOND,59);
        lastMilli= calendar.getTimeInMillis();
